...
if (isset($update['message'])) {
  ...
  if (!empty($update['text'])) {
    ...
    if ($command == "/grupos" || $command == "/grupos@llubot") {
      ...
      $textToSend .= "<a href=\"https://telegram.me/librelabucm\">Canal de noticias de LLU</a>\n";
      $textToSend .= "#<a href=\"https://telegram.me/joinchat/AC_OwECMttsmiW5vfZjo7g\">Random</a>(offtopic)\n";
      ...
      $textToSend .= "   ✔️ <a href=\"https://telegram.me/joinchat/Ar4agkCACYELE5TZ5AWtAA\">Security Team</a>\n";
